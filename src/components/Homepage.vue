<template>
  <div class="relative">
    ...
    <!-- <img
      ...
      alt=""> -->
    <div class="flex flex-col justify-between relative" style="z-index:2;">
      <div class="text-center text-5xl text-white homepage-bold py-6 mt-6 w-3/5 m-auto" style="transform:translateY(50%) !important;">
      ...
      <div class="list-reset mt-4">
        <div class="text-center text-1xl text-white homepage-bold py-6 mt-6 w-3/5 m-auto" style="transform:translateY(50%) !important;">
          <p class="py-4">
            {{ post.body }}
          </p>
        </div>
